...
class StoryBrain {
  ...
  // Resets _storyNumber to 0
  void restart() => _storyNumber = 0;

  bool buttonShouldBeVisible() => _storyNumber >= 0 && _storyNumber <= 2;

  // Returns the first storyTitle from _storyData's Story objects
  String getStory() => _storyData[_storyNumber].storyTitle;

  // Returns the first choice1 from _storyData's Story objects
  String getChoice1() => _storyData[_storyNumber].choice1;

  // Returns the first choice2 from _storyData's Story objects
